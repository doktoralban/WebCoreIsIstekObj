...
{
    public partial class WebCoreIsIstekContext : DbContext
    {
        public WebCoreIsIstekContext()
        {
        }

        public WebCoreIsIstekContext(DbContextOptions<WebCoreIsIstekContext> options)
            : base(options)
        {
        }
